...
import type { WorkspaceName } from "../domain/primitives/workspace_name.ts";
...
export const normalizePathInput = (value?: string): string | undefined => {
...
): Result<string, CoreDependencyError> => {
...
export const resolveMmHome = (): Result<string, CoreDependencyError> =>
...
const determineWorkspaceFromName = async (
  ...
  name: WorkspaceName,
): Promise<Result<string, CoreDependencyError>> => {
...
export type LoadCoreDependenciesOptions = Readonly<{
  skipSchemaCheck?: boolean;
}>;

export const loadCoreDependencies = async (
  workspacePath?: string,
  options?: LoadCoreDependenciesOptions,
): Promise<Result<CoreDependencies, CoreDependencyError>> => {
